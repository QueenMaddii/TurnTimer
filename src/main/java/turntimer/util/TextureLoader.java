...
import static turntimer.TurnTimerMain.powerPath;
import static turntimer.TurnTimerMain.resourcePath;
...
public class TextureLoader {
        ...
        if (textures.get(filePath) == null) {
            try {
                ...
                try
                {
                    ...
                    TurnTimerMain.logger.info("missing.png is missing!");
                    return null;
                }
            }
        }
    ...
    private static void loadTexture(final String textureString, boolean linearFilter) throws GdxRuntimeException {
        ...
        TurnTimerMain.logger.info("Loaded texture " + textureString);
